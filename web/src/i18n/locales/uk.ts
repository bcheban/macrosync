...
export const uk: Translation = {
  ...
  journal: {
    ...
    footnote: 'Накопичена дохідність у R — одиниця це ризик, з яким відкривалася угода. Закритих угод: {{count}}. Виходи в беззбиток рахуються як нуль і лишаються в кривій; протерміновані виклики й ті, що замінені новішим сетапом, угодами не є і не враховані.',
  },
