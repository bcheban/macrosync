...
export const uk: Translation = {
  ...
  journal: {
    ...
    footnote: 'Накопичена дохідність у R — одиниця це ризик, з яким відкривалася угода. Закритих угод: {{count}} — кожна дійшла або до цілі, або до стопу. Виклик, що завершився інакше, — ні перемога, ні програш, і на цій панелі не рахується ніде.',
  },
