...
export const uk: Translation = {
  ...
  signals: {
    ...
    winRateAt: 'вінрейт тут',
    bands: { high: 'Висока', medium: 'Середня', low: 'Низька' },
  ...
  glossary: {
    confidenceBands:
      'Наскільки сильно збіглися чотири зчитування в момент виклику. Рушій публікує лише вище 62, тож «Низька» тут означає підтверджено, але ледве — не слабко. Число поруч із фільтром — це вінрейт закритих угод на обраному рівні разом із розміром вибірки, бо відсоток на дев’яти угодах — не те саме число, що відсоток на двох сотнях.',
    leverage:
