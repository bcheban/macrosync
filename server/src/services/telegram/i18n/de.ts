...
export const de: Dictionary = {
  ...
  guideStrategiesBody: [
    ...
    '',
    '\u{1F4C5} <b>Daytrading</b> — Stundenkerzen.',
    'Die mittlere Einstellung: eine Handvoll Signale am Tag, jedes mit Luft zum Atmen.',
    '',
    '\u{1F30A} <b>Swing</b> — 4-Stunden-Kerzen.',
    'Wenige Signale, weite Stops, langes Warten. Das, was sich mit einem Job verträgt.',
    '',
    '\u26A1 <b>Scalping ist abgeschaltet.</b>',
    'Nicht weil es öfter verlor, sondern weil es mehr kostete. Eine Gebühr ist auf jeder Position gleich hoch, und der Stop eines Scalps ist der engste der drei — dieselbe Kommission frisst also ein Vielfaches seines Vorteils.',
    '',
  ...
  guideLifecycleBody: [
    '🎯 <b>Was nach dem Einstieg passiert</b>',
    '',
    'Jeder Call trägt drei Ziele und einen Stop, und der Stop steigt, sobald sich der Trade selbst bezahlt.',
    '',
    '<b>TP1</b> — realisiert <b>25%</b>. Der Stop bewegt sich <b>nicht</b>.',
    'Das ist die auffälligste Änderung. Ein Schutz hier machte fast jeden Gewinner ein Viertel einer Risikoeinheit wert, während jeder Verlierer weiterhin eine ganze kostete. Der Trade braucht Luft für den Rücksetzer, der auf ein erstes Ziel folgt.',
    '',
    '<b>TP2</b> — realisiert <b>45%</b>. Der Stop wandert auf den <b>Einstieg</b>.',
    'Siebzig Prozent der Position sind geschlossen, der Rest kann nichts mehr kosten.',
    '',
    '<b>TP3</b> — realisiert die letzten <b>30%</b>.',
    'Auf dem Weg dorthin zieht der Stop auf den TP1-Kurs nach, damit der Rest im Gewinn schließt statt am Einstieg.',
    '',
    '⏳ <b>Nichts schließt nach der Uhr.</b>',
    'Keine 24-Stunden-Timer mehr. Ein Call bleibt offen, bis der Kurs ein Ziel oder den Stop erreicht — genau wie eine Limit-Order an der Börse.',
    '',
    '📊 Bis zu <b>30</b> Calls gleichzeitig. Darüber scannt die Engine weiter und eröffnet nicht mehr.',
  ].join('\n'),
