...
export const uk: Dictionary = {
  ...
  welcomeBody:
    'Він цілодобово сканує ліквідні безстрокові контракти USDT на MEXC, і коли сетап підтверджується, ти отримуєш сигнал: вхід, три тейк-профіти, SL, причину одним реченням і плече, за якого ліквідація лишається за стопом. Щойно спрацьовує TP1, стоп переїжджає у вхід, а картка оновлюється сама — далі угода вже не може нічого коштувати.',
  welcomeSubscribed:
  ...
  guideRiskBody: [
    ...
    '',
    'Програш коштує 1R — того ризику, який ти заклав на вході. А виграш — не одне число: драбина фіксує 50% на 1R, 30% на 1.5R і 20% на 2.5R, тож угода, що пройшла всю дистанцію, дає <b>1.45R</b>, а та, що взяла першу сходинку й зупинилася в беззбитку, — <b>0.5R</b>.',
    '',
    'Цей розкид і є вся суть розміну. Фіксуючи половину рано, виграєш частіше й виграєш менше за раз.',
    '',
    'Тому єдиного беззбиткового вінрейту не існує. Якби кожен виграш проходив усю драбину, він був би <b>41%</b>; якби кожен спинявся на першій сходинці — <b>67%</b>. Справжнє число лежить між ними й рухається разом із ринком.',
    '',
