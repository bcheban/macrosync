...
export const uk: Dictionary = {
  ...
  welcomeBody:
    'Він цілодобово сканує ліквідні безстрокові контракти USDT на MEXC, і коли сетап підтверджується, ти отримуєш сигнал: вхід, TP, SL, причину одним реченням і плече, за якого ліквідація лишається за стопом.',
  welcomeSubscribed:
