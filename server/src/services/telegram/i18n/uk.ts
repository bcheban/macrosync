...
export const uk: Dictionary = {
   ...
   */
  commandHelp: {
    menu: "Основні розділи кнопками — стане в пригоді, якщо ти сховав клавіатуру внизу.",
  ...
  guideStrategiesBody: [
    ...
    '',
    '\u{1F4C5} <b>Дейтрейдинг</b> — годинні бари.',
    'Кілька сигналів на день, у кожного є простір.',
    '',
    '\u{1F30A} <b>Свінг</b> — 4-годинні бари.',
    'Мало сигналів, широкі стопи, довге очікування. Той, що сумісний із роботою.',
    '',
    '\u26A1 <b>Скальпінг вимкнено.</b>',
    'Не тому, що програвав частіше, а тому, що дорожче коштував. Комісія однакова на будь-якій позиції, а стоп у скальпа найтісніший із трьох — тож та сама комісія з\u2019їдає в рази більшу частку його краю. На записі, виміряному біля нуля, зупиняти треба саме його.',
    '',
    '<i>Сьогодні бот публікує дейтрейдинг і свінг. Обидва цілять у ширшу винагороду за той самий ризик.</i>',
  ].join('\n'),

  menuIntro: ['\u{1F9ED} <b>Куди далі?</b>', '', 'Обери розділ нижче \u2014 або введи команду, як швидше.'].join('\n'),

  guideLifecycle: '🎯 Як ведеться угода',
  guideLifecycleBody: [
    '🎯 <b>Що відбувається після входу</b>',
    '',
    'Кожен сигнал несе три цілі й один стоп, і стоп піднімається в міру того, як угода себе окуповує.',
    '',
    '<b>TP1</b> — фіксує <b>25%</b>. Стоп <b>не</b> рухається.',
    'Саме це змінилося найпомітніше. Захист на цій сходинці робив майже кожен виграш вартим чверті одиниці ризику, тоді як кожен програш коштував цілу. Угоді потрібен простір, щоб пережити відкат, який іде слідом за першою ціллю.',
    '',
    '<b>TP2</b> — фіксує <b>45%</b>. Стоп переїжджає у <b>вхід</b>.',
    'Сімдесят відсотків позиції вже закрито, і решта не може нічого коштувати.',
    '',
    '<b>TP3</b> — фіксує останні <b>30%</b>.',
    'Дорогою туди стоп підтягується до ціни TP1, тож хвіст закривається в прибутку, а не у вході, якщо рух видихнеться.',
    '',
    '⏳ <b>Ніщо не закривається за таймером.</b>',
    'Жодних 24-годинних відліків більше немає. Сигнал лишається відкритим, доки ціна не дійде до цілі або стопу — рівно як лімітний ордер на біржі. Запис і твій рахунок тепер описують ту саму угоду.',
    '',
    '📊 Одночасно може бути відкрито до <b>30</b> сигналів. Далі рушій продовжує сканувати, але перестає відкривати — замість вигадувати вихід для тієї, що вже працює.',
  ].join('\n'),
